jQuery(document).ready(function ($) {
    ...
    jQuery(".counter-slider").slick({
        ...
        dots: false,
        prevArrow:
            "<span class='slick-arrow-left'><i class='icon-arrows-2'></i></span>",
        nextArrow:
            "<span class='slick-arrow-right'><i class='icon-arrows-2'></i></span>",
        responsive: [
            {
                breakpoint: 1024,
                settings: {
    ...
    // Click to Top Button
    //***************************
    jQuery(".sportsmagazine-back-top,.sportsmagazine-top-back").on(
        "click",
        function () {
    ...
    //***************************
    jQuery(".sportsmagazine-dropdown-menu,.sportsmagazine-megamenu")
        .parent("li")
        .addClass("subdropdown-addicon");
    ...
    jQuery(function () {
        ...
        jQuery(
            "#sportsmagazine-countdown,#sportsmagazine-game-countdown,#sportsmagazine-banner-countdown"
        ).countdown({
            until: austDay,
        });
