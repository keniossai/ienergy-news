...
<head>
    ...
    <meta name="author" content="Ken Ossai" />
  ...
  <body>
    ...
    <div class="sportsmagazine-main-wrapper">
     ...
     <header id="sportsmagazine-header" class="sportsmagazine-header-one">
        ...
        <div class="sportsmagazine-main-header">
            <div class="container">
                <div class="row">
                    <aside class="col-md-2"><a href="/" class="sportsmagazine-logo"><img src="{{asset('assets/images/logo.png')}}" alt=""></a></aside>
                    <div class="col-md-10">
                                            ...
                                            <li class="row">
                                                <div class="col-md-2">
                                                    ...
                                                    <ul class="sportsmagazine-megalist">
                                                        <li><a href="fixture.html">Latest News</a></li>
                                                        <li><a href="fixture-wls.html">Energy</a></li>
                                                        <li><a href="fixture-wrs.html">Exclusive</a></li>
                                                        <li><a href="fixtures-dark1.html">Field Development</a></li>
                                                        <li><a href="fixtures-dark2.html">Production</a></li>
                                                        <li><a href="fixture-detail.html">LNG</a></li>
                                                        <li><a href="fixture-detail.html">People</a></li>
                                                        <li><a href="fixture-detail.html">Energy Transition</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-2">
                                                    <h4>REGION</h4>
                                                    <ul class="sportsmagazine-megalist">
                                                        <li><a href="fixture-detail-wls.html">Africa</a></li>
                                                        <li><a href="gallery.html">America</a></li>
                                                        <li><a href="gallery-wls.html">Asia & Oceania</a></li>
                                                        <li><a href="gallery-wrs.html">Europe</a></li>
                                                        <li><a href="gallery-modren.html">Middle East</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-2">
                                                    <h4>DEPARTMENTS</h4>
                                                    <ul class="sportsmagazine-megalist">
                                                        <li><a href="gallery-modren-wrs.html">Politics</a></li>
                                                        <li><a href="login-register.html">Financial</a></li>
                                                        <li><a href="search-result.html">Opinions</a></li>
                                                        <li><a href="404.html">Technology</li>
                                                        <li><a href="faq.html">Head to Head</a></li>
                                                        <li><a href="contact-us.html">Jobs</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-2">
                                                    <h4>DIGITAL</h4>
                                                    <ul class="sportsmagazine-megalist">
                                                        <li><a href="gallery-modren-wrs.html">Edition</a></li>
                                                        <li><a href="login-register.html">Newsletter</a></li>
                                                        <li><a href="search-result.html">Breaking News Letter</a></li>
                                                        <li><a href="404.html">RSS</a></li>
                                                        <li><a href="faq.html">Sponsor Content</a></li>
                                                        <li><a href="contact-us.html">iEnergy News App</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-2">
                                                    <h4>UPSTREAM</h4>
                                                    <ul class="sportsmagazine-megalist">
                                                        <li><a href="gallery-modren-wrs.html">NHST Event</a></li>
                                                        <li><a href="login-register.html">About Us</a></li>
                                                        <li><a href="search-result.html">Contact Us</a></li>
                                                        <li><a href="404.html">Subscribe</a></li>
                                                        <li><a href="faq.html">Faq</a></li>
                                                        <li><a href="contact-us.html">Advertise</a></li>
                                                    </ul>
                                                </div>
       ...
       @yield('content')
		...
		<footer id="sportsmagazine-footer" class="sportsmagazine-footer-one">
            ...
            <div class="sportsmagazine-copyright">
                <div class="container">
                    <div class="row">
                        <aside class="col-md-6 sportsmagazine-copyright-left"><p><a target="_blank" href="">&copy; 2022 iEnergy | All Rights reserved</a></p></aside>
                        <aside class="col-md-6 sportsmagazine-copyright-right">
                            <ul class="sportsmagazine-copyright-link">
                                ...
                                <li><a href="404.html" class="sportsmagazine-colorhover">Cookie Settings</a></li>
                            </ul>
                        </aside>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="{{asset('assets/script/fancybox.pack.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/script/isotope.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/script/progressbar.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/script/counter.js')}}"></script>
