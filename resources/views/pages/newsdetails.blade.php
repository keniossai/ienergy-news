            ...
            <div class="row">
                ...
                <div class="col-md-9">
                        ...
                        <ul>
                            <li>
                                <div class="sportsmagazine-prev-post">
                                    <figure><a href="404.html"><img src="{{asset('assets/extra-images/post-img1.jpg')}}" alt=""></a></figure>
                            ...
                            <li>
                                <div class="sportsmagazine-next-post">
                                    <figure><a href="404.html"><img src="{{asset('assets/extra-images/post-img2.jpg')}}" alt=""></a></figure>
                    ...
                    <div class="sportsmagazine-related-article sportsmagazine-blog-artical">
                        <ul class="row">
                            <li class="col-md-4">
                                <figure><a href="blog-detail.html.html"><img src="{{asset('assets/extra-images/related-articel-img1.jpg')}}" alt=""><i class="fa fa-link"></i></a></figure>
                            ...
                            <li class="col-md-4">
                                <figure><a href="blog-detail.html.html"><img src="{{asset('assets/extra-images/related-articel-img2.jpg')}}" alt=""><i class="fa fa-link"></i></a></figure>
                                <div class="sportsmagazine-article-text">
                                     <time datetime="2008-02-14 20:00">August 23rd, 2016</time>
                                     <h5><a href="blog-detail.html.html">Michael Bran as was chosen as best pl</a></h5>
                                </div>
                            ...
                            <li class="col-md-4">
                                <figure><a href="blog-detail.html.html"><img src="{{asset('assets/extra-images/related-articel-img3.jpg')}}" alt=""><i class="fa fa-link"></i></a></figure>
                                <div class="sportsmagazine-article-text">
                                     <time datetime="2008-02-14 20:00">August 23rd, 2016</time>
                                     <h5><a href="blog-detail.html.html">Michael Bran as was chosen as best pl</a></h5>
                                </div>
